...
<?php if (!Bunyad::core()->get_license()): // Not activated ?>
	<div class="ts-dash-box">
		...
		<?php elseif (!empty($error)): ?>
			...
			<p>You can try it again by refreshing this page in a few minutes. Further, please make sure your webhost allows external HTPS connections. If the problem persists, please contact Support.</p> 
...
<div class="ts-dash-box">
	...
	<ol>
		<?php if (!TGM_Plugin_Activation::get_instance()->is_tgmpa_complete()): ?>
			<li>Make sure you have activated the <a href="<?php echo esc_url(admin_url('themes.php?page=tgmpa-install-plugins')); ?>" target="_blank">required plugins</a>.</li>
		<?php endif; ?>
